...
# ── OUTPUT ──────────────────────────────────────────────────────────
printf "${W}[${R}${PRI}~/${folder}${R}${W}] [${R}${PRI}${bar_fill}${R}${SEC}${bar_empty}${R}${PRI}${ctx_pct}%%${R}${W}|${R}${SEC}${used_fmt}${R}${PRI}/${max_fmt}${R}${W}|${R}${REM_C}${rem_fmt}${R}${W}] [${R}${PRI}${cur_date}${R} ${PRI}${cur_time}${R}${W}|${R}${PRI}Exp:${R}${SEC}${exp_hm}${R}${W}] [${R}${PRI}S:${R}${SESS_C}${sess_fmt}%%${R} ${SEC}${sess_hr}${R}${W}|${R}${PRI}W:${R}${WEEK_C}${week_fmt}%%${R} ${SEC}${week_rst}${R}${W}] [${R}${CLAUDE_C}Claude${R} ${MODEL_C}${model_name}${R} ${EFF_C}${EFF}${R} ${W}]${R}${repo_block}\n"
